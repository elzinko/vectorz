...
| 033 | port-métrique-qualité-produit | **Proposé** (révisé post-panel 2026-07-22) | 🟡 la méthode **exécute l'outil**, un **tiers écrit** `quality.measured`, le **moniteur agrège** (compose 032 + 028 + 031) ; trichotomie **règle / capacité / config** ; enforcement **DoD** fail-closed (020) | **panel adverse fait** (4 lentilles + juge, findings appliqués) ; arbitrages PO ouverts : **Q2** (où vit le silo), « chemins exclus », auteur≠approbateur, séquencement ; épic [0051](../../features/0051-observabilite-qualite-produit.md) (0052→0057) |
