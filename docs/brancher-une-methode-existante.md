...
1. **Vous possédez la méthode** (skills maison, ex. mega-city) → les **consignes d'émission
   ...
   fiche [0050](../products/mega-city/features/0050-kit-emetteur-supervisabilite.md).
...
- **Les fiches** : [0050](../products/mega-city/features/0050-kit-emetteur-supervisabilite.md) (kit émetteur, en cours) → [0058](../products/mega-city/features/0058-bmad-contrat-supervisabilite.md) (le sidecar BMAD).
