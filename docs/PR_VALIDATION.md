...
> **Adaptation vectorz** : monorepo méthode (mega-city). Les lignes Émulateur / Device réel sont **N.A.** sauf si la PR touche un client mobile d'un produit consommé. Preview Vercel = N.A. sauf déploiement Vercel explicite.
