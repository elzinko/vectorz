...
## Réalisé (2026-07-26) — ADR [0021](../docs/adr/0021-cloture-portier-deterministe-ranger-rediger-juger.md)
...
- **2026-07-28 — PARK mesure (PR #62).** Portier + défaut `check` livrés (#56/#59 +
  défaut check epoch-2). AC tokens ≤28k **non mesuré** en session réelle CLEAN —
  `blocked` jusqu'à une clôture dogfood instrumentée (consigner tokens neufs dans le
  programme Journal). Code/tests verts ; rien à coder pour débloquer.
- **Ne pas confondre avec la fiche [2026](done/2026-ezk-archive-persiste-handoff.md)**
...
- Réfs : `~/.claude/agents/ezk-archive.md` (les 7 vérifications), `scripts/check.sh`,
  fiche 2076 (hygiène des branches post-squash), fiche 2085 (le signal constamment faux
