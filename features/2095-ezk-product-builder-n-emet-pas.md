...
- **2026-07-28 — PARK (refonte époque 2 / PR #62).** Consigne d'émission livrée (#55) et
  testée (contrat anti-récidive). Tous les AC restants sont **observationnels** et
  dépendent de **2094** (MCP chargé + session réelle). Pas de preuve inventée —
  `blocked` jusqu'à dogfood conjoint 2094+2095.
- Dépend de la fiche **2094** pour être *observable* — mais peut être écrite avant
  (c'est du markdown de skill).
- Ferme l'étape 2 de la fiche racine **0030**.
- **2026-07-26 — PR #55 mergée. La fiche reste ouverte volontairement** pour la
  constatation runtime (même logique que 2094).
...
- **Suivi ouvert** : fiche **2099** (vérifier la structure des directives plutôt que
  compter les mentions — finding Codex). Parenté avec **2066** : deux findings bloquants
