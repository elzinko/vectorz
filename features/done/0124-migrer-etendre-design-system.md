...
1ᵉʳ skill *étendu* migré dans mega-city (cf. [`docs/adr/0006`](../../products/mega-city/docs/adr/0006-absorber-claude-skills-catalogue2.md)).
...
(couture, pas de hardcode) → fiche 0125.
