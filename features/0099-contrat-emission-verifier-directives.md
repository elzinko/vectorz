...
`src/supervision/__tests__/skill-emission-contract.test.ts` (livré par 0095, PR #55)
...
- **Suivi de 0095** (PR #55), au même titre que 0098 l'était de #53. Le finding
...
- Parenté avec **0066** (« tester un skill/agent avant merge ») : même famille de
