...
- **Sprint ≠ PR.** Un **sprint** peut grouper **un lot cohérent** de fiches vers un **but de
  sprint** (c'est la sortie du planning — fiche [0100](2100-sprint-intake-sante-backlog-metriques.md).
...
- Relie [0100](2100-sprint-intake-sante-backlog-metriques.md (le « lot » = sortie du sprint
  planning) et [0063](done/2063-ezk-retro-ceremonie-auto-amelioration.md (la règle de composition
