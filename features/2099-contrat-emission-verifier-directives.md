...
`src/supervision/__tests__/skill-emission-contract.test.ts` (livré par 2095, PR #55)
...
- **Suivi de 2095** (PR #55), au même titre que 2098 l'était de #53. Le finding
...
- Parenté avec **2066** (« tester un skill/agent avant merge ») : même famille de
