...
> (cf. [0063 ezk-retro](done/2063-ezk-retro-ceremonie-auto-amelioration.md).
...
- 2026-07-22 — **ajout du sous-problème « réconciliation `done` ↔ PRs mergées »** (arbitrage
  ...
  *intake*). Cross-réf : [0029](2029-propagation-maj-skills.md (hook de drift des skills —
...
- 2026-07-26 — **renumérotée `0064` → `0100`** (aucun changement de fond). Cette fiche portait
  ...
  `max+1` côté racine (0065), déjà porté par [2065](2065-sprint-composition-lot-coherent.md.
  Références mises à jour : 2065, `done/0071`, ADR-0016, ADR-0018, `features/PLAN.md`.
