...
- **Fiches liées** :
  - **[0078](done/2078-mcpb-install-un-clic-supervision.md** — l'autre volet packaging (`.mcpb`,
    Claude Desktop). Même question ouverte de distribution ; cf. §Incertitude 5.
  - **[0029](2029-propagation-maj-skills.md** — propagation des MAJ *breaking* : traite les
