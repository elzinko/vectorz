...
- **Lien mega-city [2087](../features/2087-plugin-claude-code-distribution.md)**
  (distribuer le catalogue en plugin Claude Code) : **dépendance de conception**. 2087 a besoin
  ...
  branche au lieu d'en inventer une troisième. À instruire avant, ou au moins avec, 2087.
