---
name: ezk-backlog
argument-hint: "[help|init|list|add|groom|ready|review|ship|regen]"
description: >-
...
| `next --ready-only` | Renvoie LA prochaine fiche **tirable** (ready, non-épic) — point d'entrée unique d'ezk-sprint / ezk-product-builder |
