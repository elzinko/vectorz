 ...
 * BMAD `qa` workflow driven through `BMADSessionPort` (ADR-012) and the EA10
 * `OrchestratorService`. Scheduled for removal once EA10-S9 integration test
 * passes in production.
 */
export class QAAgentStep implements WorkflowStep {
  name = 'qa';
